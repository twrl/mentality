    ...
    <div rv-each-contact="contacts" class="col s12 m6 l4">
        <div class="card orange lighten-2" rv-id="contact:_id | prepend 'ui-healthcontacts-card-'">
            <div class="card-content white-text">
                <a class="grey-text small right ui-healthcontacts-btn-edit" rv-data-target="contact:_id"><i class="fa fa-pencil"></i></a><span class="card-title">{ contact:title } { contact:firstname } { contact:surname }</span>
